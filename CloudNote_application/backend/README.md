...
NOTE FROM SAM: If you're running windows, you should just need to download the proxy executable, ensure that it is named cloud_sql_proxy.exe, put it in the backend folder and run win_start.bat to get the proxy running.
